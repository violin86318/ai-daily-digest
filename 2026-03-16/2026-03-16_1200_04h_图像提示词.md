# 2026-03-16 12:00 图像提示词

## 主题
GTC 2026 开幕！OpenClaw 成为焦点，Agent 时代全面到来

## 视觉坐标

```
图片1 → 核心主题：GTC 2026 核心事件
├─ 坐标 A-01：Keynote倒计时（开幕时间）
├─ 坐标 B-05：OpenClaw 焦点（Build-a-Claw活动）
├─ 坐标 C-12：Agentic AI 崛起（产业趋势）
├─ 坐标 D-03：30K参会者（规模数据）
├─ 坐标 E-08：DGX Spark 硬件（本地Agent）
└─ 坐标 F-11：190国参与（全球生态）
```
