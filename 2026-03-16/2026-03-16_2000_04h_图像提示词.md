# 2026-03-16 20:00 图像提示词

主题：GTC 2026 开幕！Vera Rubin 发布，Keynote 倒计时

## 信息坐标

- **坐标 A-01**: 核心事件 - GTC 2026 正式开幕
- **坐标 B-02**: Vera Rubin - 新一代 AI 加速平台
- **坐标 C-03**: 推理芯片 - Agent 专用 CPU
- **坐标 D-04**: OpenClaw - 本地 Agent 部署指南
- **坐标 E-05**: Jensen Huang - Keynote 北京时间 3月17日 02:00
- **坐标 F-06**: 路线图 - Rubin 2026 → Rubin Ultra 2027 → Feynman 2028
...
Create a high-density, professional information design infographic for Xiaohongshu about「GTC 2026 开幕！Vera Rubin 正式发布，Keynote 倒计时」.
...
内容要点：
1. GTC 2026 开幕 - 3月16日-19日，圣何塞，30,000参会者
2. Vera Rubin - 新一代 AI 平台正式发布，260 TB/s NVLink 带宽
3. 推理芯片 + Agent 专用 CPU 预期发布
4. OpenClaw Playbook - DGX Spark 本地 Agent 部署指南
5. Jensen Huang Keynote - 北京时间 3月17日 02:00
6. 路线图 - Rubin 2026 → Rubin Ultra 2027 → Feynman 2028

Hashtags: #GTC2026 #Nvidia #VeraRubin #Agent #DGXSpark #黄仁勋
