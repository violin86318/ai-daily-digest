# AI 图像提示词 2026-04-06 04:00

## 主题

「2026年4月AI模型大战：Google Gemma 4发布与Anthropic政策转向」

## 图像生成 Prompt

```
Create a high-density, professional information design infographic for Xiaohongshu about「2026年4月AI模型大战：Google Gemma 4发布与Anthropic政策转向」.
...
1. **Google Gemma 4** - 基于Gemini 3架构的开源模型 (4月2日发布)
2. **GPT-5.4** - 3月5日发布，Thinking/Pro/mini变体
3. **Anthropic政策** - Claude订阅停止支持第三方工具（4月4日生效）
4. **AI医疗** - 密歇根大学AI数秒解读脑部MRI
5. **加州AI行政令** - 安全隐私保护要求