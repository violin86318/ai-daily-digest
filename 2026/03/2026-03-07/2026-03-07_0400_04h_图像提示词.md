```plaintext
Create a high-density, professional information design infographic for Xiaohongshu about「2026年3月 AI战局：Claude登顶与五角大楼之争」.
...
图片1 → 核心主题：2026年3月 AI战局
├─ 坐标 A-01：App Store排名（Claude第一）
├─ 坐标 B-05：用户增长（100万/日）
├─ 坐标 C-12：Pentagon事件时间线
├─ 坐标 D-03：Anthropic vs OpenAI 对比
├─ 坐标 E-08：供应链风险标签（史无前例）
├─ 坐标 F-11：商业影响（Nvidia投资）
└─ 坐标 G-02：编者观察（用户投票效应）
