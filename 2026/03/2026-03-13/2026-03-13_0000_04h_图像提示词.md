...
```plaintext
Create a high-density, professional information design infographic for Xiaohongshu about「2026年3月12日 AI/科技要闻」.
...
Content to include:
- 核心事件: 微软Copilot入局健康追踪
- AI要闻: Kotlin创始人新语言、Atlassian AI裁员、Claude Code分析、CJK字体合成
- 开发者动态: zi2zi-JiT、quint-lang、Emacs internals
- 科技趋势: 社交媒体成瘾审判、亚洲4天工作制、Met 3D扫描
