# 图像提示词 - 2026-03-12 08:00

## 核心主题
AI 科技动态：Google 收购 Wiz、Perplexity PC、BitNet 1-bit 模型
...
```
图片1 → 核心主题：AI Daily Digest 2026-03-12
├─ 坐标 A-01：Google 收购 Wiz（品牌阵列）
├─ 坐标 B-05：Perplexity Personal Computer（核心参数）
├─ 坐标 C-12：BitNet 100B 1-bit（技术拆解）
├─ 坐标 D-03：WebAssembly 一等公民（对比区）
├─ 坐标 E-08：Agent 安全工具（场景网格）
├─ 坐标 F-11：YC 新项目（快速检查）
└─ 坐标 G-06：更多热点（状态栏）
```
...
Create a high-density, professional information design infographic for Xiaohongshu about「2026年3月12日 AI 科技动态：Google 收购 Wiz、Perplexity 推出 PC、BitNet 100B 1-bit 模型、Agent 安全工具涌现」.
