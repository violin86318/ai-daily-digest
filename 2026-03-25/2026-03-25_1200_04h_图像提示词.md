...
```plaintext
Create a high-density, professional information design infographic for Xiaohongshu about「Anthropic Claude 发布计算机控制功能：AI Agent 竞争升级」。
...
| 坐标 | 模块 | 内容要点 |
|------|------|----------|
| A-01 | 核心事件 | Claude 计算机控制功能发布 |
| B-05 | 发布详情 | 2026.3.23, 点击/输入/导航/浏览器控制 |
| C-12 | 技术原理 | 使用客户电脑完成任务 |
| D-08 | 竞品对比 | vs OpenAI GPT, Google Gemini |
| E-03 | 市场影响 | AI Agent 竞争升级 |
| F-11 | 应用场景 | 远程工作流程自动化 |
| G-06 | 局限注意 | 仍需人类监督 |

---

*图像提示词生成 via Nano-Banana-Pro*