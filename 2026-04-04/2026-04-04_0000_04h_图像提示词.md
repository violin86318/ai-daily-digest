# 图像提示词 - 2026-04-04 00:00

## 主题

**AI 职业威胁 + 美国各州 AI 立法动态**

## 视觉坐标拆分

```
图片1 → 核心主题：AI 职业威胁与立法监管
├─ 坐标 A-01：热门话题（LinkedIn 隐私门 / AI 失业警告）
├─ 坐标 B-05：经济学家态度转变（从怀疑到认真对待）
├─ 坐标 C-12：加州 AI 监管框架（四个月制定政策）
├─ 坐标 D-03：各州立法动态（TN/SC/ID/GA 法案进度）
├─ 坐标 E-08：AI 滥用案例（青少年伪造裸照 59 受害者）
├─ 坐标 F-02：安全事件（Mercor 被黑 / LiteLLM 供应链攻击）
└─ 坐标 G-07：太空进展（Artemis II 4K 激光通信）
```

## 生成提示词

```plaintext
Create a high-density, professional information design infographic for Xiaohongshu about「AI 职业威胁与美国各州 AI 立法动态 - 2026年4月」.
...
如需替换，可选：
- LinkedIn 隐私丑闻 + Linux 游戏里程碑
- 瑞典教育反转 + DRM 涨价影响

---

*生成时间: 2026-04-04 00:04 CST*
