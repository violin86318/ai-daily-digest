# AI Daily Digest - 2026-04-09 20:00 图像提示词
...
AI 领域最新动态：数据中心不推高电价 / 爱尔兰AI就业影响 / ESRI研究报告

---

## 图像生成 Prompt

Create a high-density, professional information design infographic for Xiaohongshu about「2026年4月AI领域核心洞察：IER研究表明AI数据中心并未推高美国电价，爱尔兰ESRI报告称7%工作将受影响，高技能工作者面临更大风险」.
...
- [MOD 1: BRAND ARRAY] - Reference Figure 1's grid: A 4x4 or 3x3 matrix of options, with one "Best Choice" highlighted in Fluorescent Pink. (数据中心州分布展示)
- [MOD 2: SPECS SCALE] - A technical ruler or gauge showing "Standard" vs "Premium" with precise numerical increments. (数据中心耗电量增长：76→176 TWh)
- [MOD 3: DEEP DIVE] - A technical sketch of the product with "zoom-in" callout circles showing internal components. (IER研究方法论)
- [MOD 4: SCENARIO GRID] - Comparison cards separated by fine 0.5pt hair-lines. (高增长vs低增长州电价对比)
- [MOD 5: WARNING ZONE] - A high-contrast Pink/Black area for "Pitfalls to Avoid". (ESRI：7%工作将被替代)
- [MOD 6: QUICK CHECK] - A small, dense summary table resembling a lab data sheet. (高风险vs低风险职业)
- [MOD 7: STATUS BAR] - A vertical or horizontal stack of information blocks like Figure 2's class schedule. (政策走向：Ratepayer Protection Pledge)
